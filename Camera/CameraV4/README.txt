/*
THE FOLLOWING CHANGES WERE MADE TO FIREBASEFS.H IN ORDER FOR THE SD IMAGE SAVING AND UPLOAD TO FIREBASE TO PROPERLY FUNCTION
1.) spiff section removed
2.) defined file format changed to SDMMC when esp32 is defined
*/
